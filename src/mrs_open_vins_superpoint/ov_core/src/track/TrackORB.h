...
#ifndef OV_CORE_TRACK_ORB_H
#define OV_CORE_TRACK_ORB_H
 ...
 */
class TrackORB : public TrackBase {
...
public:
   ...
   */
  explicit TrackORB(std::unordered_map<size_t, std::shared_ptr<CamBase>> cameras, int numfeats, int numaruco, bool stereo,
...
protected:
  ...
  void perform_detection_stereo(const cv::Mat &img0, const cv::Mat &img1, const cv::Mat &mask0, const cv::Mat &mask1,
                                ...
                                std::vector<cv::KeyPoint> *pts0_raw = nullptr, std::vector<cv::KeyPoint> *pts1_raw = nullptr);
