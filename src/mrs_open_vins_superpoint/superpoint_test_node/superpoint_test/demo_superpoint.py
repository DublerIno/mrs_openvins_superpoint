...
class SuperPointNet(torch.nn.Module):
  ...
  def forward(self, x):
    ...
    return semi, desc
  def save_model_binary(self, path):
    """ Save model as custom binary format. should work to load in C++.
    """
...
class SuperPointFrontend(object):
  ...
  def run(self, img):
    ...
    self.net.save_model_binary('superpoint_model_weights.bin')
...
if __name__ == '__main__':
  ...
  parser.add_argument('--weights_path', type=str, default='superpoint_weights.pth',
      help='Path to pretrained weights file (default: superpoint_weights.pth).')
