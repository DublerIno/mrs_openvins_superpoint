...
DEFAULT_CONFIG="$SCRIPTPATH/ov_config_flighforge/estimator_config.yaml"
...
echo "[flightforge] OV_CONFIG_PATH=$OV_CONFIG_PATH"
echo "[flightforge] OV_SUPERPOINT_PYTHON=$OV_SUPERPOINT_PYTHON"
